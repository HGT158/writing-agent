...
| 文档 | 用途 |
|---|---|
| [architecture/phase1-architecture.md](architecture/phase1-architecture.md) | 架构单一事实来源（v1.25） |
...
下列文档记录具体版本的设计与实施边界，用于追溯决策，不是当前架构的单一事实来源；后续版本已经改变其中部分契约，冲突时以 v1.25 主架构为准。
