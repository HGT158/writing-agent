...
| 文档 | 用途 |
|---|---|
| [architecture/phase1-architecture.md](architecture/phase1-architecture.md) | 架构单一事实来源（v1.32） |
...
| [reviews/phase10-code-review.md](reviews/phase10-code-review.md) | v1.28–v1.31 四提交区间复审（助手编辑、加固批次、记忆系统、模型/提供商切换）；无 P0，3 P1 / 8 P2 / 23 P3；文档口径项（P3-6/P3-7/P3-23 与 P2-8 文档分支）已由 v1.32 关闭，代码侧修复待排期，观察项登记 backlog |
